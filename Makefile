...
ENGINE_SRCS = main.c raycasting.c render_3D_game.c mini_map.c textuer_utils.c utils.c input_handling.c raycasting_utils.c normalize_map.c utils_2.c utils_3.c
